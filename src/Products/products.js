            ...
            <div className="reflow-product-list ref-cards">
              <div className="ref-products">
                <a
                  ...
                  href="/product.html?product=717978921"
                >
                  ...
                  <div className="ref-product-data">
                    <div className="ref-product-info">
                      <h5 className="ref-name">Product</h5>
                      <p className="ref-excerpt">
                        Porro eius voluptate quia necessitatibus.
                      </p>
                    </div>
                ...
                <div className="ref-addons">
                  <a
                    ...
                    href="/product.html?product=717978921"
                  />
                  <a className="ref-button preview-toggle" href="#">
                    Add to Cart
                  </a>
                </div>
                <a
                  className="ref-product"
                  href="/product.html?product=505747444"
                >
                  <div className="ref-media">
                    <img
                      className="ref-image"
                  ...
                  <div className="ref-product-data">
                    <div className="ref-product-info">
                      <h5 className="ref-name">Product</h5>
                      <p className="ref-excerpt">
                        Non et cum officia consequatur consectetur in.
                      </p>
                    </div>
                ...
                <a
                  className="ref-product"
                  href="/product.html?product=326414015"
                >
                  <div className="ref-media">
                    <img
                      className="ref-image"
                  ...
                  <div className="ref-product-data">
                    <div className="ref-product-info">
                      <h5 className="ref-name">Product</h5>
                      <p className="ref-excerpt">
                        Eius dolores id quis doloribus consectetur et.
                      </p>
                    </div>
                    <strong className="ref-price"></strong>
                  </div>
                </a>
                <div className="ref-addons">
                  <a
                ...
                <a
                  className="ref-product"
                  href="/product.html?product=138824058"
                >
                  <div className="ref-media">
                    <img
                      className="ref-image"
                      src="https://cdn.bootstrapstudio.io/products/product-27_md.jpg"
                      loading="lazy"
                    />
                  </div>
                  <div className="ref-product-data">
                    <div className="ref-product-info">
                      <h5 className="ref-name">Product</h5>
                      <p className="ref-excerpt">
                        Corporis non voluptatem aliquid ea deserunt iusto minus.
                      </p>
                    </div>
                    <strong className="ref-price"></strong>
                  </div>
                ...
                <a
                  className="ref-product"
                  href="/product.html?product=2106712069"
                >
                  <div className="ref-media">
                    <img
                      className="ref-image"
                  ...
                  <div className="ref-product-data">
                    <div className="ref-product-info">
                      <h5 className="ref-name">Product</h5>
                      <p className="ref-excerpt">
                        Exercitationem autem occaecati magni.
                      </p>
                    </div>
                    <strong className="ref-price"></strong>
                  </div>
                ...
                <a
                  className="ref-product"
                  href="/product.html?product=1927510720"
                >
                  <div className="ref-media">
                    <img
                      className="ref-image"
                ...
                <a
                  className="ref-product"
                  href="/product.html?product=1715279243"
                >
                  <div className="ref-media">
                    <img
                      className="ref-image"
                  ...
                  <div className="ref-product-data">
                    <div className="ref-product-info">
                      <h5 className="ref-name">Productr</h5>
                      <p className="ref-excerpt">
                        Deleniti ut dolores consectetur omnis.
                      </p>
                    </div>
                    <strong className="ref-price"></strong>
                  </div>
              ...
              <div className="ref-product-preview">
                ...
                <div className="ref-product-preview-content" />
              </div>
            </div>
          </div>
        </div>
